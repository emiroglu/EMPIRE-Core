...
IGAMortarCouplingMatrices::IGAMortarCouplingMatrices(int _size_N , int _size_R)
{
    ...
    isIGAWeakDirichletConditions = false;
...
void IGAMortarCouplingMatrices::setIsIGAConditions(bool _isIGAWeakDirichletConditions, bool _isIGAPatchContinuityConditions, bool _isClampedDofs) {
    isClampedDofs = _isClampedDofs;
    isIGAWeakDirichletConditions = _isIGAWeakDirichletConditions;
