 ...
 */
/***********************************************************************************************//**
 * \file CurveSurfaceCorotate2DMapper.h
 * This file holds the class CurveSurfaceCorotate2DMapper
 * \date 2/6/2015
 **************************************************************************************************/
...
/********//**
 * \brief Class CurveSurfaceCorotate2DMapper performs 2D corotate algorithm to reconstruct the deformed
 *        surface of a deformed curve. Corotate2D allows large translation/rotation in 2D and small displacement
 *        for the rest. See Non-linear Modeling and Analysis of Solids and Structures (Krenk2009)
