 ...
 */
/***********************************************************************************************//**
 * \file CurveSurfaceLinearMapper.h
 * This file holds the class CurveSurfaceLinearMapper
 * \date 2/6/2015
 **************************************************************************************************/
...
/********//**
 * \brief Class CurveSurfaceLinearMapper performs linear Bernoulli algorithm to reconstruct the deformed
 *        surface of a deformed curve. It allows only small displacements.
